...
(function (window, undefined) {
	...
	K.options = {
		...
		colorTable : [
			['#E53333', '#E56600', '#FF9900', '#FFD24D', '#DFC5A4', '#FFE500'],
			['#009900', '#006600', '#99BB00', '#93FF26', '#60D978', '#00D5FF'],
	...
	_extend(KCmd, {
		...
		removeformat : function() {
			var map = {
					'*' : '.font1-weight,.font1-style,.text-decoration,.color,.background-color,.font1-size,.font1-family,.text-indent'
				},
				tags = _STYLE_TAG_MAP;
...
KindEditor.lang({
	...
	'multiimage.invalidFiletype' : 'æ–‡ä»¶ç±»åž‹ä¸æ­£ç¡®ã€‚',
	...
	'filemanager.orderType' : 'æŽ’åºæ–¹å¼ï¼š',
