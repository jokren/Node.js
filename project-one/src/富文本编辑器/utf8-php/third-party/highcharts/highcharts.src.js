...
defaultOptions = {
	...
	chart: {
		...
		//spacingLeft: 10,
		style: {
			fontFamily: '"Lucida Grande", "Lucida Sans Unicode", Verdana, Arial, Helvetica, sans-serif', // default font1
			fontSize: '12px'
		},
...
SVGRenderer.prototype = {
				...
				if (span !== '' || spans.length === 1) {
					...
					if (span !== ' ') {
						...
						if (!spanNo && lineNo) {
							...
							// Set the line height based on the font1 size of either
	...
	/**
	 * Utility to return the baseline offset and total line height from the font1 size
	 */
	fontMetrics: function (fontSize) {
		fontSize = pInt(fontSize || 11);

		// Empirical values found by comparing font1 size and bounding box height.
		// Applies to the default font1 family. http://jsfiddle.net/highcharts/7xvn7/
...
Axis.prototype = {
	...
	defaultOptions: {
		...
		title: {
			...
			style: {
				color: '#4d759e',
				//font1: defaultFont.replace('normal', 'bold')
				fontWeight: 'bold'
			}
			//x: 0,
			//y: 0
